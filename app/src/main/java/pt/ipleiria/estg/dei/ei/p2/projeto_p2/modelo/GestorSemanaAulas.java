...
public enum GestorSemanaAulas {
    ...
    private LinkedList<Professor> professores; //lista de professores
    private LinkedList<Segurança> segurancas;
    ...
    public void adicionar(Segurança seguranca) {
    ...
    public void remover(Segurança seguranca) {
